...
function f1() {
    ...
    setTimeout(function () {
        console.log("[function]\t\t[test-" + 1 + "]\t\t[sign] = " + _this.sign);
    }, 267);
}
...
var handler = {
    ...
    init: function init() {
        ...
        document.addEventListener('click', function (event) {
            return _this3.doSomething(event.type);
        }, false);
    },
...
function es6function() {
    ...
    setTimeout(function () {
        console.log("[function]\t\t[test-" + 3 + "]\t\t[sign] = " + _this4.sign);
    }, 100);
}
// babel 转换后
function es6function() {
...
function f2() {
    ...
    setTimeout(function () {
        console.log("[function]\t\t[test-" + 4 + "]\t\t[arguments] = ", _arguments);
...
(function () {
    ...
    return [function () {
        return console.log("[function]\t\t[test-" + 5 + "]\t\t[this.x] = ", _this6.x);
    }.bind({ x: 'inner' })()];
}).call({ x: 'outer' });
