...
Object.assign(ClassA.prototype, {
  ...
  setCamnter: function setCamnter(camnter) {
 ...
 * 配上箭头函数
 */
var mergeA = function mergeA(target) {
...
var mergeB = function mergeB() {
  for (var _len2 = arguments.length, source = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
    source[_key2] = arguments[_key2];
  }

  return Object.assign.apply(Object, [{}].concat(source));
};
...
//# sourceMappingURL=object-6-compiled.js.map