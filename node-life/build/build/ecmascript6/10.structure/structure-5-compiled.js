 ...
 * 字符串 - 值 对
 */
var objectKey = { save: 'Save you from anything' };
(function () {
    var lowLevelMap = {};
 ...
 * 数组的成员是 键值对数组
 */
var keyValueArray = [['name', 'CaMnter'], ['save', 'Save you from anything']];
(function () {
    ...
    // 不是键值对的数组
    var array = ['CaMnter', 'Save you from anything'];
    try {
...
(function () {
    var map = new Map();
    // 原理
    keyValueArray.map(function (k, v) {
        return map.set(k, v);
    });
})();
 ...
 */
(function () {
    var array = [[true, 'Boolean key'], ['true', 'String key']];
    var map = new Map(array);
...
//# sourceMappingURL=structure-5-compiled.js.map