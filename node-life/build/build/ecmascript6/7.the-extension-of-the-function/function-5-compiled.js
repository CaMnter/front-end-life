...
// ES6
console.log("[function]\t\t[test-" + 1 + "]\t\t[Math.max(...[2, 6, 7])] = " + Math.max.apply(Math, [2, 6, 7]));
// ES6 的写法等同于普通调用
...
// ES6
console.log("[function]\t\t[test-" + 3 + "]\t\t[new Date(...[2017, 7, 17])] = " + new (Function.prototype.bind.apply(Date, [null].concat([2017, 7, 17])))());

//# sourceMappingURL=function-5-compiled.js.map