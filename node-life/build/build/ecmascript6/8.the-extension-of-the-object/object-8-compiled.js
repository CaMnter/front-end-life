...
(function () {
    ...
    var keys = Reflect.ownKeys((_Reflect$ownKeys = {}, _defineProperty(_Reflect$ownKeys, Symbol(), 0), _defineProperty(_Reflect$ownKeys, "b", 0), _defineProperty(_Reflect$ownKeys, 10, 0), _defineProperty(_Reflect$ownKeys, 2, 0), _defineProperty(_Reflect$ownKeys, "a", 0), _Reflect$ownKeys));
    console.log("[object]\t\t[test-" + 6 + "]\t\t[Reflect.ownKeys(obj)] = ", keys);
})();

//# sourceMappingURL=object-8-compiled.js.map