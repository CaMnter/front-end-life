        ...
        render: function () {
            return (
                <View style={styles.horizontal}>
                    <Image source={require('./Thumbnails/uie_thumb_normal.png')}
                           style={styles.icon}/>
                    <Image source={require('./Thumbnails/uie_thumb_selected.png')}
                           style={styles.icon}/>
                    <Image source={require('./Thumbnails/uie_comment_normal.png')}
                           style={styles.icon}/>
                    <Image source={require('./Thumbnails/uie_comment_highlighted.png')}
                           style={styles.icon}/>
                </View>
            );
        },
