...
class SelectionExample extends React.Component {
    ...
    selectRandom() {
        let positions = [this.getRandomPosition(), this.getRandomPosition()].sort();
...
const examples = {
    ...
    pagerBlocks: [
        ...
        },
        {
            ...
            render: function () {
                let autoCapitalizeTypes = [
                    'none',
                    'sentences',
                    'words',
                    'characters',
                ];
                let examples = autoCapitalizeTypes.map((type) => {
                    return (
                        <TextInput
                            key={type}
                            autoCapitalize={type}
        ...
        },
        {
            ...
            render: function () {
                ...
                let examples = keyboardTypes.map((type) => {
                    return (
                        <TextInput
                            key={type}
                            keyboardType={type}
                ...
                return (
                    <View>
                        ...
                        <TextInput
                            ...
                            <Text style={styles.multiline}>multiline with children, aligned
                                bottom-right</Text>
                        </TextInput>
                    </View>
                );
        ...
        },
        {
            ...
            render: function () {
                ...
                let examples = returnKeyTypes.map((type) => {
                    return (
                        <TextInput
                            key={type}
                            returnKeyType={type}
                ...
                let types = returnKeyLabels.map((type) => {
                    return (
                        <TextInput
                            key={type}
                            returnKeyLabel={type}
