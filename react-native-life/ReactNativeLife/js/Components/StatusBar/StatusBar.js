        ...
        return (
            <View>
                ...
                <TouchableHighlight
                    ...
                    <View style={styles.button}>
                        <Text>setTranslucent(true) and setBackgroundColor('rgba(0, 0, 0, 0.4)',
                            true)</Text>
                    </View>
                </TouchableHighlight>
                <TouchableHighlight
...
class StatusBarExample extends React.Component {
    ...
    render() {
        return (
            <RNTesterPage title="StatusBar Examples">
                <RNTesterBlock title="StatusBar hidden">
                    <StatusBarHiddenExample />
                </RNTesterBlock>

                <RNTesterBlock title="StatusBar style">
                    <StatusBarStyleExample />
                </RNTesterBlock>

                <RNTesterBlock title="StatusBar network activity indicator">
                    <StatusBarNetworkActivityExample />
                </RNTesterBlock>

                <RNTesterBlock title="StatusBar background color">
                    <StatusBarBackgroundColorExample />
                </RNTesterBlock>

                <RNTesterBlock title="StatusBar background color">
                    <StatusBarTranslucentExample />
                </RNTesterBlock>

                <RNTesterBlock title="StatusBar static API">
                    <StatusBarStaticIOSExample />
                </RNTesterBlock>

                <RNTesterBlock title="StatusBar dimensions">
                    <View>
