    ...
    pagerBlocks: [
            ...
            render() {
                return (
                    <Text style={{padding: 10}}>
                        padding = 10px padding = 10px padding = 10px padding = 10px
                    </Text>
                );
            }
        },
            ...
            render() {
                return (
                    <View>
                        ...
                        <Text>
                            Mixed text with <Text
                            style={{textDecorationLine: 'underline'}}>underline</Text> and <Text
                            style={{textDecorationLine: 'line-through'}}>line-through</Text> text
                            nodes
                        </Text>
                    </View>
                );
            ...
            render() {
                return (
                    <Text style={{lineHeight: 35}}>
                        Holisticly formulate inexpensive ideas before best-of-breed benefits. <Text
                        style={{fontSize: 20}}>Continually</Text> expedite magnetic potentialities
                        rather than client-focused interfaces.
                    </Text>
                );
            }
        },
        ...
        },
        {
            ...
            render() {
                return (
                    <Text selectable>
                        This text is selectable if you click-and-hold, and will offer the native
                        Android
                        selection menus.
                    </Text>
                );
        ...
        },
        {
            ...
            render() {
                return (
                    <Text>
                        This text contains an inline image <Image
                        source={require('../../../RNTester/js/Thumbnails/flux.png')}/>.
                        Neat, huh?
                    </Text>
                );
            }
                ...
                return (
                    <View>
                        ...
                        <Text>
                            ...
                            upper-case
                            accents or other ascenders. With some fonts, this can make text look
                            slightly misaligned when centered vertically.
                        </Text>
                    </View>
                );
            }
